...
!function($){
  ...
  $.fn.jeimsongwapo = function(options){
    return this.each(function(){
      ...
      if (settings.wrapContent == false) {
        el.prepend("<div class='ibg-bg Aligner'></div>")
      } else {
        el.wrapInner("<div class='ibg-bg Aligner'></div>")
      }
      ...
      if (el.data("ibg-bg") !== undefined) {
        el.find("> .ibg-bg").css({
          background: "url('" + el.data("ibg-bg") + "') no-repeat",
